...
Además de la rica fauna, Paracas es un lugar perfecto para practicar deportes acuáticos, disfrutar de paseos en bote y deleitarse con la gastronomía marina local, famosa por sus ceviches y platos frescos preparados con productos del Pacífico.', 'Ica', 120.00, '../../assets/img/destination_islas_ballestas.jpg', 3),
...
Además de su belleza natural, la Laguna Humantay tiene un significado espiritual para las comunidades locales. Es considerada sagrada y se realizan rituales para rendir homenaje a la Pachamama (Madre Tierra), lo que añade una dimensión cultural y mística a la experiencia.', 'Cusco', 90.00, '../../assets/img/destination_laguna_humantay.jpg
', 2),
...
', 'Puno', 80.00, '../../assets/img/destination_isla_taquile.jpg', 3),
...
Recorrer Chan Chan es como adentrarse en una ciudad fantasma que aún conserva su grandeza. Sus plazas ceremoniales, depósitos y templos ofrecen una visión única de la vida en esta antigua metrópoli. El contraste entre el desierto costero y las imponentes estructuras de barro hace de este lugar una experiencia inolvidable.', 'La Libertad', 140.00, '../../assets/img/destination_chan_chan.jpg', 7),

...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url("../../assets/css/styleHomePage.css") ?>">
...
<body>
    ...
    if (isset($_SESSION['view_profile'])) {
        include(ROOT_PATH . '/views/viewProfileModal.php');
        unset($_SESSION['view_profile']);
    }
    ...
    <aside class="hero_section__sidebar" id="dynamic_sidebar">
        ...
        <nav class="hero_section__header__nav">
            <a href="<?= base_url("destinations") ?>" onclick="burger_buttonClicked()">Destinos</a>
            <a href="<?= base_url("#about_us_section") ?>" onclick="burger_buttonClicked()">Acerca de Nosotros</a>
            <a href="<?= base_url("#contact_us_section") ?>" onclick="burger_buttonClicked()">Contacto</a>
        </nav>
    </aside>
    <header class="hero_section__burger_container" id="dynamic_burger_container">
        ...
        <nav>
            <a class="" id="button_login_mobile" href="<?= base_url("login") ?>">Iniciar Sesión</a>
            <a class="button_sign_up" id="button_sign_up_mobile" href="<?= base_url("register") ?>">Registrarme</a>
            <button class="button_profile_user" id="button_profile_user_mobile" type="button"></button>
        </nav>
    </header>
    <main>
        <section class="hero_section">
            <img class="hero_section_bg" src="<?= base_url("../../assets/img/home_page_bg.webp") ?>" alt="">
            ...
            <div style="position: relative; padding: 40px 0;">
                <header class="hero_section__header" id="dynamic_header">
                    ...
                    <nav class="hero_section__header__nav">
                        <a href="<?= base_url("destinations") ?>">Destinos</a>
                        <a href="<?= base_url("#about_us_section") ?>">Acerca de Nosotros</a>
                        <a href="<?= base_url("#contact_us_section") ?>">Contacto</a>
                        <a class="" id="button_login" href="<?= base_url("login") ?>">Iniciar Sesión</a>
                        <a class="button_sign_up" id="button_sign_up" href="<?= base_url("register") ?>">Registrarme</a>
            ...
            <div class="hero_section__cta_box">
                ...
                <form action="<?= base_url("formPlanningTrip") ?>">
    ...
    <script src="<?= base_url("../scripts/scriptHeroSection.js") ?>"></script>
    <script src="<?= base_url("../scripts/scriptLoadDestinations.js") ?>"></script>
    <script>
